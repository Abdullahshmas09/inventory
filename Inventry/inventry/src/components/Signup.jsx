...
function Signup() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.fname || !formData.lname || !formData.email || !formData.phone || !formData.password) {
            alert("please fill in all the fields")
        } else if
            (formData.lname.length < 7) {
    ...
    return (
        <Container maxWidth="lg">
            <Grid2 container spacing={2}>
                ...
                <Grid2 md={6} sx={{
                    marginLeft: "2rem", marginTop: "3rem",
                    ...
                    <form action="" method="get" onSubmit={handleSubmit}>
                        <Box display="flex" flexDirection="column" gap={2}>
                            ...
                            <Box display="flex" sx={{ marginTop: ".3rem" }} gap={2}>
                                ...
                                <TextField
                                    ...
                                    inputProps={{
                                        pattern: "^0[0-9]{10}$",
                                        title: "Phone number must start with 0 followed by 9 digits"
                                    }}
                                    required
                                />
                            ...
                            <Box display="flex" mx="" my="" sx="">
                                <FormControlLabel control={<Checkbox defaultChecked />} label="I agree to all terms, privacy policies, and fees" />
                            </Box>


                        </Box>
                        <Button variant="contained" size='large' type='submit' sx={{
                            background: "#101540", marginTop: ".3rem",
                            "@media(max-width:600px)": {
                                width: "100%"
                            }
                        }}>
                        ...
                        <Box display="flex" mx="" my="" sx="">
                            <p>Already have an account? <a style={{ textDecoration: "none" }} href="/login">Log in</a></p>
                        </Box>
                    </form>
                </Grid2>
            </Grid2>
